...
<div class="layer">
   <form name="pwreset">
      <input type="hidden" value="${id}" id="comp_id" name="comp_id"/>
         ...
         <tr>
               <td width="400"><input type="password" name="comp_pw" id="comp_pw" onkeyup="Pwd()" style='width:100%;background-color:white;border:0;outline:0;'>
          ...
          <tr>
               <td width="400">
                  <input type="password" name="comp_pw_re" onkeyup="checkPwd()"style='width:100%;background-color:white;border:0;outline:0;'/>
